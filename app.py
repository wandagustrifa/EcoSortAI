...
st.markdown(
    ...
    * {
    ...
    .upload-card-content { /* This div is injected via markdown */
        display: flex;
    ...
    .upload-icon { /* This is injected via markdown */
        font-size: 3rem;
        margin-bottom: 1rem;
        display: block;
    }
    
    .upload-title { /* This is injected via markdown */
        font-size: 1.3rem;
        font-weight: 600;
        color: #1e293b;
    ...
    .upload-subtitle { /* This is injected via markdown */
        color: #64748b;
        font-size: 1rem;
        font-weight: 500;
        margin-bottom: 1rem;
    ...
    .stFileUploader label {
        ...
        background: linear-gradient(135deg, #8A9AF5 0%, #B3A8F8 100%) !important;
    ...
    /* Custom Camera Input */
    /* Target the st.CameraInput's main div */
    .stCameraInput {
        width: 100%; /* Occupy full width of its parent column container */
        margin-top: auto; /* Push to bottom of flex container */
        display: flex; /* Make it a flex container to center its contents */
    ...
    .stButton > button { 
        ...
        background: linear-gradient(135deg, #4EE2A8 0%, #2ED599 100%) !important;
        color: white !important;
        border: none !important;
        border-radius: 12px !important; 
        padding: 12px 24px !important;
...
with st.container(): # Main container for overall app layout
    ...
    if image_source is not None:
        ...
        if predicted_label:
            color = category_colors.get(predicted_label, '#6366f1')
